export type RuntimeErrorCode='RUNTIME_INVALID_TRANSITION'|'RUNTIME_UNAUTHORIZED'|'RUNTIME_CANCELLED'|'RUNTIME_TIMEOUT'|'RUNTIME_CONCURRENCY_LIMIT'|'RUNTIME_EXECUTION_FAILED';
